...
GEMINI_ANALYSIS_TIMEOUT = int(os.getenv("GEMINI_ANALYSIS_TIMEOUT", "300"))
GEMINI_FOLLOWUP_CHAT_TIMEOUT = int(os.getenv("GEMINI_FOLLOWUP_CHAT_TIMEOUT", "120"))
GEMINI_FOLLOWUP_PODCAST_TIMEOUT = int(os.getenv("GEMINI_FOLLOWUP_PODCAST_TIMEOUT", "120"))
